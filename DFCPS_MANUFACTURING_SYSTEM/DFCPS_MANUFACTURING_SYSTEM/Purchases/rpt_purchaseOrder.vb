...
Public Class rpt_purchaseOrder
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DFCPS_MANAGEMENT_SYSTEM.rpt_purchaseOrder.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_purchaseOrder
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_purchaseOrder = New rpt_purchaseOrder()
        rpt.Site = Me.Site
        Return rpt
    End Function
